...
public class SaleService {
    ...
    public Page<SaleResponse> getAllSales(String search, UUID sellerEntityId, UUID buyerEntityId, UUID buyerUserId, TransactionStatus status, java.time.OffsetDateTime startDate, java.time.OffsetDateTime endDate, UUID actorId, Pageable pageable) {
        ...
        return saleRepository.findAllSecured(safeSearch, searchFlag, sellerEntityId, buyerEntityId, buyerUserId, status, safeStart, safeEnd, startFlag, endFlag, actorId, allowedEntities, pageable)
                .map(this::toResponse);
    }
        ...
        return SaleResponse.builder()
                ...
                .items(s.getItems().stream()
                        .map(i -> {
                            ...
                            return SaleResponse.ItemResponse.builder()
                                .id(i.getId())
